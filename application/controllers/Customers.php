    ...
    public function save($customer_id = -1) {
        ...
        if ($this->Customer->save_customer($person_data, $customer_data, $customer_id)) {
            ...
            if ($customer_id == -1) {
                ...
                InjAuditLog(array(
                    'action' => $this->lang->line('customers_new'),
                    'ref_text' => $customer_data['person_id'],
                    'ref_id' => $customer_data['person_id'],
                    'url' => uri_string()
                ));
                ...
                echo json_encode(array('success' => TRUE,
                    ...
                    'id' => $customer_id));
                InjAuditLog(array(
                    'action' => $this->lang->line('customers_update'),
                    'ref_text' => $customer_id,
                    'ref_id' => $customer_id,
                    'url' => uri_string()
                ));
            }
