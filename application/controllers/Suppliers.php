    ...
    public function save($supplier_id = -1) {
        ...
        if ($this->Supplier->save_supplier($person_data, $supplier_data, $supplier_id)) {
            ...
            if ($supplier_id == -1) {
                ...
                InjAuditLog(array(
                    'action' => $this->lang->line('suppliers_new'),
                    'ref_text' => $supplier_data['person_id'],
                    'ref_id' => $supplier_data['person_id'],
                    'url' => uri_string()
                ));
                ...
                echo json_encode(array('success' => TRUE,
                    ...
                    'id' => $supplier_id));
                InjAuditLog(array(
                    'action' => $this->lang->line('suppliers_update'),
                    'ref_text' => $supplier_id,
                    'ref_id' => $supplier_id,
                    'url' => uri_string()
                ));
            }
