...
class Receiving_lib {
    ...
    public function get_receiving_status() {
        if (!$this->CI->session->userdata('recv_receiving_status')) {
            $this->set_receiving_status('draft');
        }
        return $this->CI->session->userdata('recv_receiving_status');
    }

    public function set_receiving_status($reference) {
        $this->CI->session->set_userdata('recv_receiving_status', $reference);
    }

    public function clear_receiving_status() {
        $this->CI->session->unset_userdata('recv_receiving_status');
    }
    ...
    public function get_stock_destination($storefor = 'store') {
