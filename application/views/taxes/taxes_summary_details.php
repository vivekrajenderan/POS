...
<div id="page_title" class="text-center"><?php echo $title ?>
    <?php echo anchor($controller_name, '<span class="glyphicon glyphicon-plus">&nbsp</span>' . $this->lang->line('module_taxes'), array('class' => 'btn btn-info btn-sm  pull-right', 'id' => 'show_sales_button', 'style' => 'margin-left: 3px;')); ?>
...
<?php $this->load->view('partial/daterangepicker'); ?>
        ...
        $("#daterangepicker").on('apply.daterangepicker', function (ev, picker) {
            window.location = '<?php echo site_url($controller_name); ?>/summary_taxes_detail/' + start_date + '/' + end_date;
