...
<div id="page_title" class="text-center">
    <?php echo $this->lang->line('reports_purchase_order_history');?>
    <?php echo anchor($controller_name,  '<span class="glyphicon glyphicon-plus">&nbsp</span>'.$this->lang->line('module_purchase_order'), array('class' => 'btn btn-info btn-sm  pull-right', 'id' => 'show_sales_button','style'=>'margin-left: 3px;')); ?>
</div>
<div id="toolbar">
