...
<div class="print_hide" id="control_buttons" style="text-align:right">
    ...
    <?php echo anchor("purchase_order/lists", '<span class="glyphicon glyphicon-list">&nbsp</span>' . $this->lang->line('po_history'), array('class' => 'btn btn-info btn-sm', 'id' => 'show_sales_button')); ?>
