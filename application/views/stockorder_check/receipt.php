...
<div class="print_hide" id="control_buttons" style="text-align:right">
    ...
    <?php echo anchor("stockorder_check/lists", '<span class="glyphicon glyphicon-list">&nbsp</span>' . $this->lang->line('stockordercheck_list'), array('class' => 'btn btn-info btn-sm', 'id' => 'show_sales_button')); ?>
    <?php echo anchor("stockorder_check", '<span class="glyphicon glyphicon-save">&nbsp</span>' . $this->lang->line('stockordercheck_register'), array('class' => 'btn btn-info btn-sm', 'id' => 'show_sales_button')); ?>
</div>
...
if (isset($location_names)) {
    ?>
        ...
        ?>
        <div id="sale_id"><?php echo $this->lang->line('stockordercheck_req_ref') . ": " . $stock_order_id; ?></div>
        <div id="sale_id"><?php echo $this->lang->line('stockordercheck_soc_ref') . ": " . $receiving_id; ?></div>
        <?php
        if (!empty($reference)) {
            ?>
    ...
    <table id="receipt_items">
        <tr>
            ...
            <th style="width:20%;"><?php echo $this->lang->line('grn_receiving_qty'); ?></th>
...
foreach (array_reverse($cart, TRUE) as $line => $item) {
    ...
    ?>
            <tr>
                ...
                <td><?php echo to_quantity_decimals($item['received_quantity']); ?></td>
...
?>	
        <tr>
            ...
            <td style='border-top:2px solid #000000;'></td>
            <td style='border-top:2px solid #000000;'></td>
            <td style='border-top:2px solid #000000;'><div class=""><?php echo $receiving_quantity; ?></div></td>
        </tr>
    </table>
