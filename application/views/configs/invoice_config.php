<?php echo form_open('config/save_invoice/', array('id' => 'invoice_config_form', 'class' => 'form-horizontal')); ?>
	<div id="config_wrapper">
		<fieldset id="config_info">
            ...
            <div class="form-group form-group-sm">
				<?php echo form_label($this->lang->line('config_invoice_number_prefix'), 'invoice_number_prefix', array('class' => 'control-label col-xs-2')); ?>
				<div class='col-xs-2'>
					<?php echo form_input(array(
						'name' => 'invoice_number_prefix',
						'id' => 'invoice_number_prefix',
						'class' => 'form-control input-sm',
						'value' => $this->config->item('invoice_number_prefix'))); ?>
				</div>
			</div>
