...
<div id="page_title" class=" text-center">
    ...
    if ($controller_name == 'customers') {
        ?>
        <button class='btn btn-info btn-sm pull-right modal-dlg' style="margin-left: 10px" data-btn-submit='<?php echo $this->lang->line('common_submit') ?>' data-href='<?php echo site_url($controller_name . "/excel_import"); ?>'
    ...
    <?php }
        ...
        echo anchor($controller_name . "/rolelists",  $this->lang->line('employees_role_history'), array('class' => 'btn btn-info btn-sm pull-right')); 
    }
    ?>  
    

    <button class='btn btn-info btn-sm pull-right modal-dlg' data-btn-submit='<?php echo $this->lang->line('common_submit') ?>' style="margin-right: 10px" data-href='<?php echo site_url($controller_name . "/view"); ?>'
            title='<?php echo $this->lang->line($controller_name . '_new'); ?>'>
        <span class="glyphicon glyphicon-user">&nbsp</span><?php echo $this->lang->line($controller_name . '_new'); ?>
    </button>
    
</div>
<!--<div id="title_bar" class="btn-toolbar text-center">
<?php
if ($controller_name == 'customers') {
    ?>
