...
<?php echo form_open('promo/save/' . ((isset($id)) ? $id : ''), array('id' => 'promo_form', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal')); ?>
<fieldset id="item_basic_info">
    ...
    <div class="form-group form-group-sm">
        ...
        <div class='col-xs-3'>
            ...
            echo form_input(array(
                ...
                'id' => 'promo_fromdate',
                'class' => 'form-control input-sm',
                'value' => (isset($promo_fromdate)) ? $promo_fromdate : '')
            );
            ?>
        </div>
        ...
        <div class='col-xs-3'>
            ...
            echo form_input(array(
                ...
                'id' => 'promo_todate',
                'class' => 'form-control input-sm',
                'value' => (isset($promo_todate)) ? $promo_todate : '')
            );
            ?>
        </div>
    </div>
        ...
        <div class="col-xs-3">
            <div class="input-group input-group-sm">
                ...
                echo form_input(array(
                    ...
                    'id' => 'promo_price',
                    'class' => 'form-control input-sm',
                    'value' => (isset($promo_price)) ? to_currency_no_money($promo_price) : '')
                );
                ?>
                <?php if (currency_side()): ?>
                    <span class="input-group-addon input-sm symbol">
    ...
    <div class="form-group form-group-sm">
        <?php echo form_label($this->lang->line('promo_store'), 'promo_store', array('class' => 'required control-label col-xs-3')); ?>
        <div class='col-xs-8'>
            <?php echo form_dropdown('promo_store[]', $stores, $promo_store, array('id' => 'promo_store', 'class' => 'selectpicker show-menu-arrow', 'data-style' => 'btn-default btn-sm', 'multiple' => '')); ?>
        </div>
    </div>
    <div class="form-group form-group-sm">
        <?php echo form_label($this->lang->line('promo_add_item'), 'item', array('class' => 'control-label col-xs-3')); ?>
        <div class='col-xs-8'>
            <?php
            echo form_input(array(
                'name' => 'item',
    ...
    <table id="item_kit_items" class="table table-striped table-hover">
        <thead>
            <tr>
                ...
                <th width="90%"><?php echo $this->lang->line('promo_item'); ?></th>
            </tr>
        </thead>
        <tbody>
            <?php
            foreach ($promo_items as $item_kit_item) {
                ?>
                <tr>
...
<?php $this->load->view('partial/datepicker_locale'); ?>
        ...
        $('#promo_store').change(function () {
            var control=$(this);
//            if(control.val().length!=$('#promo_store option').length){
//                var array=control.val();
                    ...
                    success: function (response) {
                        if (response.success) {
                            ...
                            if (stay_open) {
                                ...
                                $("#promo_form").attr("action", "<?php echo site_url("promo/save/") ?>");
