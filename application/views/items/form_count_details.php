...
<table id="items_count_details" class="table table-striped table-hover">
    <thead>
        <tr style="background-color: #999 !important;">
            <th colspan="4"><?php echo $this->lang->line('items_data_tracking'); ?></th>
        </tr>
        <tr>
            <th width="30%"><?php echo $this->lang->line('items_date'); ?></th>
            <th width="20%"><?php echo $this->lang->line('items_employeename'); ?></th>
            <th width="20%"><?php echo $this->lang->line('items_in_out_qty'); ?></th>
            <th width="30%"><?php echo $this->lang->line('items_remarks'); ?></th>
        </tr>
    </thead>
