...
<fieldset id="inv_item_basic_info">
    ...
    <div class="form-group form-group-sm">
        ...
        <?php echo form_label($this->lang->line('items_reason'), 'adjustments', array('class' => 'control-label col-xs-1')); ?>
        <div class='col-xs-4'>
            <?php echo form_dropdown('adjustments', $adjustments_list, $adjustments, array('class' => 'form-control')); ?>
        </div>
    </div>
            ...
            messages:
                    {
                        newquantity:
                                {
                                    required: "<?php echo $this->lang->line('items_add_minus_required'); ?>",
                                    number: "<?php echo $this->lang->line('items_add_minus_invalid'); ?>"
                                }
                    }
        });
    });
