...
<fieldset id="item_basic_info">
    ...
    <?php //----Staore -------------?>
    <div class="form-group form-group-sm">
        <?php echo form_label($this->lang->line('items_stock_location'), 'quantity', array('class' => ' control-label col-xs-3')); ?>
        <?php echo form_label($this->lang->line('items_unit_price'), 'items_unit_price', array('class' => ' control-label col-xs-4')); ?>
        <?php echo form_label($this->lang->line('config_quantity_minimun'), 'quantity', array('class' => ' control-label col-xs-4')); ?>
    </div>
    <?php
    foreach ($stock_locations as $key => $location_detail) {
        ?>
        <div class="form-group form-group-sm">
            <?php echo form_label($location_detail['location_name'], 'quantity_' . $key, array('class' => 'required control-label col-xs-3')); ?>
            <div class='col-xs-4'>
                <?php
                echo form_input(array(
                    'name' => 'storeprice_' . $key,
                    'id' => 'storeprice_' . $key,
                    'class' => 'required price form-control',
                    'required' => '',
                    'value' => isset($item_info->item_id) ? $location_detail['price'] : 0)
                );
                ?>
            </div>
            <div class='col-xs-4'>
                <?php
                echo form_input(array(
                    'name' => 'storequantity_' . $key,
                    'id' => 'storequantity_' . $key,
    ...
    <?php //----warehouse -------------?>
    <div class="form-group form-group-sm">
        <?php echo form_label($this->lang->line('config_warehouse'), 'warehouse', array('class' => ' control-label col-xs-3')); ?>
        <?php echo form_label($this->lang->line('items_unit_price'), 'items_unit_price', array('class' => ' control-label col-xs-4')); ?>
        <?php echo form_label($this->lang->line('config_quantity_minimun'), 'quantity', array('class' => ' control-label col-xs-4')); ?>
    </div>
    <?php
    foreach ($warehouse as $key => $location_detail) {
        ?>
        <div class="form-group form-group-sm">
            <?php echo form_label($location_detail['location_name'], 'quantity_' . $key, array('class' => 'required control-label col-xs-3')); ?>
            <div class='col-xs-4'>
                <?php
                echo form_input(array(
                    'name' => 'warehouseprice_' . $key,
                    'id' => 'warehouseprice_' . $key,
                    'class' => 'required price form-control',
                    'required' => '',
                    'value' => isset($item_info->item_id) ? $location_detail['price'] : 0)
                );
            ...
            <div class='col-xs-4'>
                <?php
                echo form_input(array(
                    'name' => 'warehousequantity_' . $key,
                    'id' => 'warehousequantity_' . $key,
                    'class' => 'required quantity form-control',
                    'required' => '',
                    'value' => isset($item_info->item_id) ? to_quantity_decimals($location_detail['quantity']) : to_quantity_decimals(0))
                );
...
foreach ($stock_locations as $key => $location_detail) {
    ?>
    <?php echo 'storequantity_' . $key ?>:
        {
        required:true,
                remote: "<?php echo site_url($controller_name . '/check_numeric') ?>"
        },
    <?php echo 'storeprice_' . $key ?>:
        {
        required:true,
                remote: "<?php echo site_url($controller_name . '/check_numeric') ?>"
        },
...
foreach ($warehouse as $key => $location_detail) {
    ?>
    <?php echo 'warehousequantity_' . $key ?>:
        {
        required:true,
                remote: "<?php echo site_url($controller_name . '/check_numeric') ?>"
        },
    <?php echo 'warehouseprice_' . $key ?>:
        {
        required:true,
                remote: "<?php echo site_url($controller_name . '/check_numeric') ?>"
        },
