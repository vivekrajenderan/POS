        ...
        table_support.init({
            ...
            onLoadSuccess: function (response) {
                ...
                $('.deleteaction').click(function (e) {
                    e.preventDefault();
                    if (confirm('<?php echo $this->lang->line('grn_delete_confirmation_message'); ?>')) {
                        $href = $(this).attr('href');
                        $.ajax({
                            type: 'GET',
                            url: $href,
...
<div id="page_title" class="text-center">
    <?php
    echo $this->lang->line('grn_history');

    echo anchor($controller_name, '<span class="glyphicon glyphicon-plus">&nbsp</span>' . $this->lang->line('module_grn'), array('class' => 'btn btn-info btn-sm  pull-right', 'id' => 'show_sales_button', 'style' => 'margin-left: 3px;'));
    ?>
