...
<div class="print_hide" id="control_buttons" style="text-align:right">
    ...
    <?php echo anchor("grn/lists", '<span class="glyphicon glyphicon-list">&nbsp</span>' . $this->lang->line('grn_list'), array('class' => 'btn btn-info btn-sm', 'id' => 'show_sales_button')); ?>
...
if (isset($supplier)) {
    ...
    <table id="receipt_items">
        <tr>
            ...
            <th style="width:20%;" <?php echo (isset($receipt_mode))?' class="hidden"':''; echo '>';echo $this->lang->line('grn_already_received_qty'); ?></th>
...
foreach (array_reverse($cart, TRUE) as $line => $item) {
    ...
    ?>
            <tr>
                ...
                <td<?php echo (isset($receipt_mode))?' class="hidden"':''; echo '>';echo to_quantity_decimals($item['received_quantity']); ?></td>
...
?>	
        <tr>
            ...
            <td style='border-top:2px solid #000000;'></td>
            <td <?php echo (isset($receipt_mode))?' class="hidden"':'';?> style='border-top:2px solid #000000;'><div class="total-value"></div></td>
