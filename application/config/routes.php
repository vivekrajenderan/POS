...
//$route['inventories'] = 'inventories/summary_input';
$route['inventories/low/([^/]+)'] = 'inventories/low/$1';
$route['inventories/summaryvaluation/([^/]+)'] = 'inventories/summaryvaluation/$1';
$route['inventories/([^/]+)/([^/]+)'] = 'inventories/index/$1/$2';
