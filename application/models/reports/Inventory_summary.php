...
class Inventory_summary extends Report {
    ...
    public function getDataColumns() {
        return array(array('item_name' => $this->lang->line('inventory_item_name')),
            array('item_number' => $this->lang->line('inventory_item_number')),
            array('quantity' => $this->lang->line('inventory_quantity')),
            array('reorder_level' => $this->lang->line('inventory_reorder_level')),
            array('location_name' => $this->lang->line('inventory_stock_location')),
            array('cost_price' => $this->lang->line('inventory_cost_price'), 'sorter' => 'number_sorter'),
            array('unit_price' => $this->lang->line('inventory_unit_price'), 'sorter' => 'number_sorter'),
            array('subtotal' => $this->lang->line('inventory_sub_total_value'), 'sorter' => 'number_sorter'),
            array('details' => $this->lang->line('inventory_details'),'sortable' => FALSE));
    }

    public function getData(array $inputs) {
        $this->db->select('items.name, items.item_number, item_quantities.quantity, items.reorder_level, stock_locations.location_name,stock_locations.location_id, items.item_id,items.cost_price, items.unit_price, (items.cost_price * item_quantities.quantity) AS sub_total_value');
